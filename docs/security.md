---
summary: 'Security: what deepsee runs, how recovered images are protected, image content as untrusted input'
read_when:
...
| :-- | :-- | :-- |
| `gemini-api` | deepsee downloads, sends bytes inline | private-address guards, magic-byte check, 25 MB cap |
